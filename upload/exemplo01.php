...
<?php
  ...
  //$_SERVER guarda o tipo do metodo da request. 
  //Aqui o if() Verificar se a chamada  do tipo POST
  if($_SERVER["REQUEST_METHOD"]==="POST"){
     
    //Aqui e guardado as informaçoes do arquivo que sera recebido: name, tamanho, tipo, etc.
    //A variavel $_FILES e a responsavel por receber o arquivo enviado.
    ...
    //Aqui e criado o diretorio onde sera guardado os arquivos subidos. Se ele ja existir ele apenas sob o arquivo
    $dirUploads = "uploads";
    ...
    //o move_uploaded_file realiza a mudança do arquivo do temp para o diretrio "uploads" 
